  ...
  <footer data-testid="uq-footer" id="footer" class="uq-footer" data-gtm-category="Footer">
      <div class="uq-footer__reconciliation">
        <div class="uq-footer__acknowledgement">
          <img class="uq-footer__acknowledgement-flag" alt="Australian Aboriginal Flag" src="https://static.uq.net.au/v14/images/rap/aboriginal.svg">
          <img class="uq-footer__acknowledgement-flag" alt="Torres Strait Islander Flag" src="https://static.uq.net.au/v14/images/rap/torres-strait-islanders.svg">
