    ...
    return `
            ...
            <div id="askus-menu" class="closed-menu" style="display: none">
                <ul class="askus-menu-list" role="menu" tabindex="-1">
                    ...
                    <!-- Chat -->
                    <li role="menuitem" aria-disabled="false">
                        <a onclick="javascript: window.open('https://support.my.uq.edu.au/app/chat/chat_launch_lib/p/45', 'chat', 'toolbar=no, location=no, status=no, width=400, height=400');">
                            ...
                            <span>Chat</span>
                            <span class="chatTimes"><span id="chatStart">8am</span> - <span id="chatEnd">8pm</span></span></span>
                        </a>
                    </li>
                    ...
                    <li role="menuitem" aria-disabled="false">
                        <a href="https://web.library.uq.edu.au/contact-us" rel="noreferrer">
                            ...
                            <span>Phone</span>
                            <span class="chatTimes"><span id="phonetStart">8am</span> - <span id="phoneEnd">8pm</span></span></span>
                        </a>
                    </li>
