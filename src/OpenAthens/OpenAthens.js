...
template.innerHTML = `
    ...
    <div id="open-athens" data-testid="open-athens" class="uq-card">
        <fieldset class="uq-card__content">
            ...
            <button id="open-athens-create-link-button" data-testid="open-athens-create-link-button" class="uq-button hidden" data-analytics="openathens-createlink">Create Link</button>
            <button id="open-athens-url-clear-button" data-testid="open-athens-url-clear-button" class="uq-button uq-button--secondary hidden" data-analytics="openathens-clear-before">Clear</button>
            <span id="open-athens-copy-options" data-testid="open-athens-copy-options" class="hidden">
                ...
                <button id="open-athens-visit-link-button" data-testid="open-athens-visit-link-button" class="uq-button" data-analytics="openathens-visit">Visit Link</button>
                <button id="open-athens-copy-link-button" data-testid="open-athens-copy-link-button" class="uq-button" data-analytics="openathens-copy">Copy Link</button>
                <button id="open-athens-create-new-link-button" data-testid="open-athens-create-new-link-button" class="uq-button uq-button--secondary" data-analytics="openathens-clear-after">Clear</button>
