...
class OpenAthens extends HTMLElement {
    ...
    addEventListeners() {
        ...
        this.createLinkButton.addEventListener('click', () => this.testTheUrl());
    ...
    getUrl(cleanedUrl) {
        ...
        console.log('OpenAthens::getUrl', dest);
        return dest;
    }
    ...
    getOpenAthens(url) {
        console.log('getOpenAthens start');
