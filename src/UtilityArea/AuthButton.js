                ...
                <div class="md-menu-content prm-user-menu-content" role="menu">
                    <ul id="account-menu-list" data-analyticsid="mylibrary-menu-list-public" class="mylibrary-menu-list" role="menu">
                        ...
                        <li role="menuitem" aria-disabled="false">
                            <a tabindex="0" data-testid="mylibrary-menu-borrowing" data-analyticsid="mylibrary-menu-borrowing" href="https://search.library.uq.edu.au/account?vid=61UQ_INST:61UQ&section=overview" rel="noreferrer" style="padding-top: 0">
                        ...
                        <!-- Primo Favourites -->
                        <li role="menuitem" aria-disabled="false">
                            <a tabindex="0" data-testid="mylibrary-menu-saved-items" data-analyticsid="mylibrary-menu-saved-items" href="https://search.library.uq.edu.au/favorites?section=items&vid=61UQ_INST:61UQ" rel="noreferrer">
