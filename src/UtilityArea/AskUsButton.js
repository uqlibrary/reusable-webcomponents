    ...
    <div id="askus">
        ...
        <div id="askus-chat-status">
            <div id="askus-chat-online" style="display: none;" title="Chat online">
                <svg class="askus-chat-status-icon" focusable="false" viewBox="0 0 24 24" aria-hidden="true" id="chat-status-icon-online" data-testid="chat-status-icon-online"><path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z"></path></svg>
            </div>
           <div id="askus-chat-offline" style="display: none;" title="Chat currently offline">
                <svg class="askus-chat-status-icon" focusable="false" viewBox="0 0 24 24" aria-hidden="true" id="chat-status-icon-offline" data-testid="chat-status-icon-online"><path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z"></path></svg>
            </div>
        </div>
    </div>
    <!-- Screen wrapper -->
...
class AskUsButton extends HTMLElement {
    ...
    addButtonListeners(shadowDOM, isOnline) {
        ...
        // Chat status
        function openChat() {
            window.open('https://support.my.uq.edu.au/app/chat/chat_launch_lib/p/45', 'chat', 'toolbar=no, location=no, status=no, width=400, height=400');
        }
