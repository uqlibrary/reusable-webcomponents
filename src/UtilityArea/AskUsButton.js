...
template.innerHTML = `
    ...
    <div id="askus">
        <!-- Button -->
        <button id="askus-button" data-testid="askus-button" aria-label="AskUs contact options" part="button" title="AskUs contact options">
        ...
        <div id="askus-menu" data-testid="askus-menu" class="closed-menu" style="display: none">
            ...
            <ul class="askus-menu-list" role="menu" >
                ...
                <li id="askus-faq-li" role="menuitem" aria-disabled="false">
                    <a tabindex="0" href="https://support.my.uq.edu.au/app/library/faqs" rel="noreferrer" data-testid="askus-menu-faq" target="_blank">
                ...
                <li role="menuitem" aria-disabled="false">
                    <a tabindex="0" href="mailto:askus@library.uq.edu.au" data-testid="askus-menu-email" target="_blank">
                ...
                <li id="askus-phone-li" role="menuitem" aria-disabled="false">
                    <a tabindex="0" id="askus-phone-link" href="https://web.library.uq.edu.au/contact-us" rel="noreferrer" data-testid="askus-menu-phone" target="_blank">
                ...
                <!-- Contact form -->
                <li role="menuitem" aria-disabled="false">
                    <a tabindex="0" href="https://support.my.uq.edu.au/app/library/contact" rel="noreferrer" data-testid="askus-menu-contactform" target="_blank">
                ...
                <li id="askus-menu-item-moreways" role="menuitem" aria-disabled="false" style="width: 99%">
                    <a tabindex="0" href="https://web.library.uq.edu.au/contact-us" rel="noreferrer" data-testid="askus-menu-moreways" target="_blank">
