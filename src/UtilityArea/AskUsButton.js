    ...
    <div id="askus">
        ...
        <div id="askus-menu" data-testid="askus-menu" data-analyticsid="askus-menu" class="closed-menu" style="display: none">
            ...
            <ul class="askus-menu-list" role="menu" >
                ...
                <li id="askus-aibot-li" class="askus-aibot-li" role="menuitem" aria-disabled="false" style="margin-top: -16px !important;">
                    <a tabindex="0" id="askus-aibot-button" data-testid="askus-aibot-button" data-analyticsid="askus-menu-aibot" style="display: flex; align-items: center;">
                        <svg viewBox="0 0 194 194" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 36px; height: 36px; margin-left: 0">
                            <g clip-path="url(#clip0_389_61)">
                                ...
                                <path d="M78.7749 108.73C83.9224 113.423 90.6372 116.025 97.603 116.025C104.569 116.025 111.284 113.423 116.431 108.73" stroke="white" stroke-width="6.0625" stroke-linecap="round" stroke-linejoin="round" fill="#ffffff"></path>
                        ...
                        <span style="margin-top: 4px">Chatbot</span>
