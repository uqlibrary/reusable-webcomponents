...
template.innerHTML = `
    ...
    <div id="proactivechat" class="proactive-chat">
        ...
        <div id="proactive-chat-wrapper"  class="pcwrapper" data-testid="proactive-chat-wrapper" style="display: none">
            <div id="proactive-chat" class="pcopen" data-testid="proactive-chat-open">
                <div class="pcText">
