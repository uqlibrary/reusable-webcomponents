...
var uq = function (exports) {
            ...
            value: function handleToggle(togglers) {
                ...
                return function (e) {
                    ...
                    if (toggle.classList.contains("".concat(_this6.className, "__toggle--active"))) {
                        ...
                        if (toggle.closest(".".concat(_this6.className)).classList.contains("".concat(_this6.className, "--is-manual"))) {
    ...
    var Tabs = /*#__PURE__*/function () {
        ...
        function Tabs(options) {
            ...
            if (options !== null && options !== void 0 && options.container && Tabs.isHTMLElement(options === null || options === void 0 ? void 0 : options.container)) {
                this.container = options.container;
            } // Define selectors for working elements


            this.tabListSelector = options !== null && options !== void 0 && options.tabListSelector ? options.tabListSelector : '.uq-tabs__tab-list';
            this.tabSelector = options !== null && options !== void 0 && options.tabSelector ? options.tabSelector : '.uq-tabs__tab';
            this.tabPanelSelector = options !== null && options !== void 0 && options.tabPanelSelector ? options.tabPanelSelector : '.uq-tabs__tab-panel'; // Bind handler method context
        ...
        _createClass(Tabs, [{
            ...
            key: "checkTabFocus",
            value: // Only activate tab on focus if it still has focus after the delay
