...
var uq = (function (exports) {
    ...
    })();
    {
        ...
        //                 console.log('subNavToggles=', subNavToggles);
        //                 !!mobileToggle && mobileToggle.addEventListener('click', this.handleMobileToggle);
        //                 !!subNavItems && subNavItems.forEach(function (item) {
        ...
        //                 });
        //                 !!subNavLinks && subNavLinks.forEach(function (item) {
        //                     if (window.matchMedia('(min-width: 1024px)').matches) {
        //                         item.addEventListener('touchend', _this2.handleToggle);
        //                     }
        //                 });
        //                 !!subNavL2Items && subNavL2Items.forEach(function (item) {
        //                     _this2.setOrientation(item);
        //
        //                     item.addEventListener('mouseenter', _this2.handleToggle);
        //                     item.addEventListener('mouseleave', _this2.handleToggle);
        //                 });
        //                 !!subNavL2Links && subNavL2Links.forEach(function (item) {
        //                     item.addEventListener('touchend', _this2.handleToggle);
        //                 });
        //                 !!navLinks && navLinks.forEach(function (item) {
        //                     item.addEventListener('keydown', _this2.handleKeyPress);
        //                 });
        //                 !!subNavToggles && subNavToggles.forEach(function (item) {
        ...
        //                 var target = !!this.nav && this.nav.querySelectorAll('.'.concat(this.level1Class));
        ...
        //                 !!target && target.forEach(function (el) {
        ...
        //
        //                 if (!!menuItem && menuItem.tagName !== 'LI') {
        //                     menuItem = menuItem.parentElement;
        //                 }
        //
        //                 var subNav = !!menuItem && menuItem.querySelector('ul');
        //
        ...
        //                 !!subNav && subNav.classList.add(this.openModifier);
        //                 !!menuItem && menuItem.classList.add(this.levelOpenModifier);
        //                 !!menuItem && menuItem.querySelector('a').setAttribute('aria-expanded', 'true');
        //                 !!menuItem && menuItem.querySelector('button').setAttribute('aria-expanded', 'true');
        //                 !!menuItem && menuItem.querySelector('button').setAttribute('aria-pressed', 'true');
        //             },
        //         },
        //         {
        //             key: 'closeLevel',
        //             value: function closeLevel(subNav, menuItem) {
        //                 !!subNav && subNav.classList.remove(this.openModifier);
        //                 this.setOrientation(menuItem);
        //                 !!menuItem && menuItem.classList.remove(this.levelOpenModifier);
        //                 !!menuItem && menuItem.querySelector('a').setAttribute('aria-expanded', 'false');
        //                 !!menuItem && menuItem.querySelector('button').setAttribute('aria-expanded', 'false');
        //                 !!menuItem && menuItem.querySelector('button').setAttribute('aria-pressed', 'false');
        //                 !!menuItem && menuItem.parentNode.querySelector('ul').setAttribute('aria-expanded', 'false');
        //                 !!menuItem && menuItem.parentNode.querySelector('ul').setAttribute('aria-pressed', 'false');
        //             },
        //         },
        //         {
        //             key: 'closeNav',
        //             value: function closeNav(menuItem) {
        //                 !!menuItem && menuItem.classList.remove(this.openModifier);
        //                 !!menuItem && menuItem.parentNode.querySelector('ul').setAttribute('aria-expanded', 'false');
        //                 !!menuItem && menuItem.parentNode.querySelector('ul').setAttribute('aria-pressed', 'false');
        //             },
        //         },
        ...
        //                 var _this4 = this;
        //
        //                 var levels = !!this.nav && this.nav.querySelectorAll('.'.concat(this.subNavClass));
        //                 levels.forEach(function (level) {
        //                     var item = !!level && level.querySelector('.'.concat(_this4.level2Class));
        //
        ...
        //                 var subNav = !!item && item.querySelector('.'.concat(this.level2Class));
            ...
            [
                ...
                },
                {
                    ...
                    value: function init() {
                        ...
                        function hashInListOfHashesToBeIgnored() {
                            console.log('hashNotInListOfHashesToBeIgnored', this.hash);
                            return this.hash === '#keyword=;campus=;weekstart=';
                        }

                        if (this.hash && this.hash !== '' && !hashInListOfHashesToBeIgnored.call(this)) {
