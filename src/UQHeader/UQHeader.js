...
template.innerHTML = `
    ...
    <div class="uq-header__container">
        <div class="uq-header__menu-toggle" data-target="global-mobile-nav" data-gtm-category="Primary header">
            <button id="mobile-menu-toggle-button" data-testid="mobile-menu-toggle-button" type="button" 
        ...
        <div class="uq-header__nav-primary" data-testid="uq-header-primary-nav" data-analyticsid="uq-header-primary-nav">
            <nav class="uq-header__nav-primary-container" aria-label="primary navigation">
                <ul class="uq-header__nav-primary-list">
                    <li class="uq-header__nav-primary-item"><a class="uq-header__nav-primary-link nav-primary-link" href="https://study.uq.edu.au/" data-gtm-label="Study">Study</a>
                    </li>
                    <li class="uq-header__nav-primary-item"><a class="uq-header__nav-primary-link nav-primary-link" href="https://research.uq.edu.au/" data-gtm-label="Research">Research</a>
                    </li>
                    <li class="uq-header__nav-primary-item"><a class="uq-header__nav-primary-link nav-primary-link" href="https://partners-community.uq.edu.au" data-gtm-label="Partners and community">Partners and community</a>
                    </li>
                    <li class="uq-header__nav-primary-item"><a class="uq-header__nav-primary-link nav-primary-link" href="https://about.uq.edu.au/" data-gtm-label="About">About</a>
                    </li>
                </ul>
            </nav>
        </div>
