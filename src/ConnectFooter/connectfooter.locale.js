...
export default {
    connectFooter: {
        buttonSocialHeader: 'Connect with the Library',
        buttonSocial: [
            {
                dataId: 'connect-blog-link',
                iconPath:
