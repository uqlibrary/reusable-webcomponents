                    ...
                    <div class="contacts griditem griditem12 gridmd4">
                        ...
                        <div class="gridcontainer spacingxs1">
                            <div class="griditem gridxsauto" id="buttonSocial-0">
                                <a href="https://web.library.uq.edu.au/blog" target="_blank" class="buttonBase button socialButtonClass buttonContained buttonContainedPrimary" tabindex="0" type="button" aria-label="Library Blog" data-testid="connect-footer-blog-link" id="socialbutton-0" title="Library Blog">
                            ...
                            <div class="griditem gridxsauto" id="buttonSocial-1">
                                <a href="https://twitter.com/UQ_Library" target="_blank" class="buttonBase button socialButtonClass buttonContained buttonContainedPrimary" tabindex="0" type="button" aria-label="Library on Twitter" data-testid="connect-twitter-link" id="socialbutton-1" title="Library on Twitter">
                                    <span class="buttonLabel">
                                        <svg class="svgIcon" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <div class="griditem gridxsauto" id="buttonSocial-2">
                                <a href="https://www.facebook.com/uniofqldlibrary" target="_blank" class="buttonBase button socialButtonClass buttonContained buttonContainedPrimary" tabindex="0" type="button" aria-label="Library on Facebook" data-testid="connect-facebook-link" id="socialbutton-2" title="Library on Facebook">
                                    <span class="buttonLabel">
                                        <svg class="svgIcon" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <div class="griditem gridxsauto" id="buttonSocial-3">
                                <a href="https://www.instagram.com/uniofqldlibrary/" target="_blank" class="buttonBase button socialButtonClass buttonContained buttonContainedPrimary" tabindex="0" type="button" aria-label="Library on Instagram" data-testid="connect-instagram-link" id="socialbutton-3" title="Library on Instagram">
                                    <span class="buttonLabel">
                                        <svg class="svgIcon" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <div class="griditem gridxsauto" id="buttonSocial-4">
                                <a href="https://www.youtube.com/user/uqlibrary" target="_blank" class="buttonBase button socialButtonClass buttonContained buttonContainedPrimary" tabindex="0" type="button" aria-label="Library on YouTube" data-testid="connect-youtube-link" id="socialbutton-4" title="Library on YouTube">
                                    <span class="buttonLabel">
                                        <svg class="svgIcon" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div class="givingWrapper griditem griditem12 gridmd4">
                        <div class="gridcontainer MuiGrid-spacing-xs-2">
                            <div class="givingBlock griditem griditem12">
                                <a href="https://web.library.uq.edu.au/about-us/friends-library" class="buttonBase button buttonContained givingButtonClass buttonFullWidth" tabindex="0" type="button" data-testid="connect-friends-link">
                                    <span class="buttonLabel">Join Friends of the Library</span>
                                    <span class="touchRipple"></span>
                                </a>
                            </div>
                            <div class="givingBlock griditem griditem12">
                                <a href="https://alumni.uq.edu.au/uq-library" class="buttonBase button buttonContained givingButtonClass buttonFullWidth" tabindex="0" type="button" data-testid="connect-give-link">
