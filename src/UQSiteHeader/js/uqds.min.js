        ...
        return (
            _createClass(e, [
                    ...
                    value: function (e) {
                        ...
                        n.classList.toggle('uq-site-header__navigation-toggle--close'),
                            ...
                            s.forEach(function (e) {
                                !!e && e.classList.toggle(t.openModifier), e.setAttribute('aria-expanded', !i);
                            });
                    },
                },
                {
                ...
                },
                {
                    key: 'openLevel',
                    value: function (e, t) {
                        !!e && e.classList.add(this.openModifier),
                            !!t && t.classList.add(this.levelOpenModifier),
                            !!t && t.querySelector('a').setAttribute('aria-expanded', 'true');
                    },
                },
                {
                    key: 'closeLevel',
                    value: function (e, t) {
                        !!e && e.classList.remove(this.openModifier),
                            this.setOrientation(t),
                            !!t && t.classList.remove(this.levelOpenModifier),
