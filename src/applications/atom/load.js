...
if (typeof readyFryer !== 'function') {
    ...
    function moveActionMenuToSiteHeader(siteHeader) {
        ...
        const actionMenuHeading = document.querySelector(
            '[aria-labelledby="quick-links-menu"] li:has(h6.dropdown-header)',
        );
