        ...
        items: [
            {
                ...
                placeholder: 'Find books, articles, past exams and more',
                link:
                    'https://search.library.uq.edu.au/discovery/search?query=any,contains,[keyword]' +
                    primoPrefix +
            ...
            },
            {
                ...
                placeholder: 'Enter a keyword, article title, author, ISSN',
                link:
                    'https://search.library.uq.edu.au/discovery/search?query=any,contains,[keyword]' +
                    primoPrefix +
            ...
            },
            {
                ...
                link:
                    'https://search.library.uq.edu.au/discovery/search?query=title,contains,[keyword],AND' +
                    primoPrefix +
            ...
            },
            {
                ...
                link: 'https://search.library.uq.edu.au/discovery/dbsearch?query=any,contains,[keyword]&tab=jsearch_slot&vid=61UQ_INST:61UQ&offset=0&databases=any,[keyword]',
            },
            {
                selectId: '7',
            ...
            },
            {
                ...
                placeholder: 'Enter a course code',
                link: 'https://uq.rl.talis.com/search.html?q=[keyword]&login=1',
            },
        ],
    },
    footerLinks: [
        {
            ...
            linkto: 'https://search.library.uq.edu.au/discovery/search?vid=61UQ_INST:61UQ&mode=advanced',
            display: [...PRIMO_ELEMENTS],
        },
        {
            label: 'Database search',
            linkto: 'https://search.library.uq.edu.au/discovery/dbsearch?vid=61UQ_INST:61UQ',
            display: [...PRIMO_ELEMENTS],
        },
        {
        ...
        },
        {
            ...
            linkto: 'https://search.library.uq.edu.au/discovery/collectionDiscovery?vid=61UQ_INST:61UQ',
            display: [...PRIMO_ELEMENTS],
        },
    ],
};
