            ...
            <form id="primo-search-form" class="searchForm" role="search">
                ...
                <div id="search-parent" class="searchPanel MuiGrid-container MuiGrid-spacing-xs-1 MuiGrid-align-items-xs-flex-end">
                    ...
                    <div id="input-field-wrapper" class="MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-true">
                        <div id="search-portal-autocomplete" class="MuiAutocomplete-root" data-testid="primo-search-autocomplete" data-analyticsid="primo-search-autocomplete" aria-label="Select Search Type">
                ...
                if (!!suggestiondisplay && !!suggestion.text && !!suggestion[urlsource]) {
                    ...
                    !!anchor &&
                        anchor.addEventListener('keydown', function (e) {
                            ...
                            if (isArrowDownKeyPressed(e) && !!eventTargetId) {
                                e.preventDefault();
                            ...
                            } else if (isArrowUpKeyPressed(e) && !!eventTargetId) {
                                e.preventDefault();
                                const currentId = eventTargetId.replace('suggestion-link-', '');
                                if (currentId === '0') {
        ...
        function submitHandler() {
            return function (e) {
                ...
                if (!!formObject?.currentInputfield) {
                    ...
                    const searchType = !!matches && matches.length > 0 ? matches[0] : /* istanbul ignore next */ false;
                    const keyword = !!formObject && encodeURIComponent(formObject.currentInputfield);
                    const link =
                        !!searchType &&
                        !!searchType.link &&
