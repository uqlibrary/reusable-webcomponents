describe('EzProxy', () => {
    ...
    context('copy url mode', () => {
        context('success', () => {
            beforeEach(() => {
                cy.visit('http://localhost:8080/index-ezproxy.html');
            });
        ...
        context('failure', () => {
            it('shows expected error messages when Open Athens is not working', () => {
                cy.visit('http://localhost:8080/index-ezproxy.html?requestType=error');
            ...
            it('shows expected error messages for non OA url', () => {
                cy.visit('http://localhost:8080/index-ezproxy.html?requestType=failure');
